...
export default function Terms(){
    ...
    return(
        <>
        <NavLight/>
        <section className="relative md:pt-44 pt-32 pb-8 bg-gradient-to-b from-green-400/20 dark:from-green-400/40 to-transparent">
            <div className="container relative">
                <div className="grid grid-cols-1 text-center mt-6">
                    ...
                    <ul className="tracking-[0.5px] mb-0 inline-block mt-5">
                        <li className="inline-block capitalize text-[15px] font-medium duration-500 ease-in-out hover:text-green-400"><Link href="/">Mortal.Ai</Link></li>
                        <li className="inline-block text-base mx-0.5 ltr:rotate-0 rtl:rotate-180"><i className="mdi mdi-chevron-right"></i></li>
                        <li className="inline-block capitalize text-[15px] font-medium duration-500 ease-in-out text-green-400" aria-current="page">Terms</li>
                    </ul>
                </div>
            </div>
        </section>
                    ...
                    <div className="md:w-3/4">
                        <div className="p-6 bg-white dark:bg-slate-900 shadow dark:shadow-gray-800 rounded-md">
                            ...
                            <ul className="list-none text-slate-400 mt-3">
                                <li className="flex mt-2"><i className="mdi mdi-arrow-right text-green-400 text-lg align-middle me-2"></i>Digital Marketing Solutions for Tomorrow</li>
                                <li className="flex mt-2"><i className="mdi mdi-arrow-right text-green-400 text-lg align-middle me-2"></i>Our Talented & Experienced Marketing Agency</li>
                                <li className="flex mt-2"><i className="mdi mdi-arrow-right text-green-400 text-lg align-middle me-2"></i>Create your own skin to match your brand</li>
                                <li className="flex mt-2"><i className="mdi mdi-arrow-right text-green-400 text-lg align-middle me-2"></i>Digital Marketing Solutions for Tomorrow</li>
                                <li className="flex mt-2"><i className="mdi mdi-arrow-right text-green-400 text-lg align-middle me-2"></i>Our Talented & Experienced Marketing Agency</li>
                                <li className="flex mt-2"><i className="mdi mdi-arrow-right text-green-400 text-lg align-middle me-2"></i>Create your own skin to match your brand</li>
                            </ul>
                            ...
                            <div className="mt-6">
                                <Link href="" className="py-2 px-5 inline-block font-semibold tracking-wide border align-middle duration-500 text-base text-center bg-green-400 hover:bg-green-500 border-green-400 hover:border-green-500 text-white rounded-md">Accept</Link>
                                <Link href="" className="py-2 px-5 inline-block font-semibold tracking-wide border align-middle duration-500 text-base text-center bg-transparent hover:bg-green-400 border-green-400 text-green-400 hover:text-white rounded-md ms-2">Decline</Link>
                            </div>
                        </div>
                    </div>
                </div>

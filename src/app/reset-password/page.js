                        ...
                        <div className="rounded shadow bg-white dark:bg-slate-900 p-6">
                            ...
                            <form className="text-start mt-4">
                                <div className="grid grid-cols-1">
                                    ...
                                    <div className="mb-4">
                                        <input type="submit" className="py-2 px-5 inline-block tracking-wide border align-middle duration-500 text-base text-center bg-green-400 hover:bg-green-500 border-green-400 hover:border-greenbg-green-500 text-white rounded-md w-full" value="Send"/>
                                    </div>

        ...
        <section className="relative md:py-48 py-36 items-center mt-[74px] md:mx-4 md:rounded-3xl overflow-hidden">
            ...
            <div className="container relative">
                <div className="grid grid-cols-1 text-center">
                    <div className="">
                        <h4 className="font-bold lg:leading-normal leading-normal text-white text-4xl lg:text-7xl mb-5">Create AI videos <br/> from <span className="bg-gradient-to-br from-green-400 to-fuchsia-600 text-transparent bg-clip-text"> just text.</span> </h4>
                        ...
                        <div className="mt-6">
                            <Link href="" className="py-2 px-5 inline-block font-semibold tracking-wide border align-middle duration-500 text-base text-center bg-green-400 hover:bg-green-500 border-green-400 hover:border-green-500 text-white rounded-md">Start Free Trail</Link>
                        </div>
                    </div>
                </div>
            </div>

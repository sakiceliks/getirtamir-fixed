                ...
                <div className="grid grid-cols-1 text-center mt-6">
                    ...
                    <div className="text-center subcribe-form mt-4 pt-2">
                        <form className="relative mx-auto max-w-xl">
                            ...
                            <button type="submit" className="py-2 px-5 inline-block font-semibold tracking-wide align-middle duration-500 text-base text-center absolute top-[2px] end-[3px] h-[46px] bg-green-400 hover:bg-green-500 border border-green-400 hover:border-green-500 text-white rounded-md">Search</button>
                        </form>
                    </div>
                </div>
            </div>
                        ...
                        aboutData.map((item,index)=>{
                            ...
                            <div className="text-center px-6 mt-6" key={index}>
                                <div className="relative overflow-hidden text-transparent -m-3">
                                    <FiHexagon className="h-24 w-24 fill-green-400/10 mx-auto"/>
                                    <div className="absolute top-2/4 -translate-y-2/4 start-0 end-0 mx-auto text-green-400 rounded-xl duration-500 text-2xl flex align-middle justify-center items-center">
                                        <Icon/>
                                    </div>
                                </div>

                                <div className="content mt-7">
                                    <Link href="" className="title h5 text-lg font-medium hover:text-green-400">FAQs</Link>
                                    <p className="text-slate-400 mt-3">The phrasal sequence of the is now so that many campaign and benefit</p>
                                    <div className="mt-4">
                                        <Link href="" className="hover:text-green-400">Read More <i className="mdi mdi-arrow-right"></i></Link>
                                    </div>
                                </div>
                            </div>
                            )

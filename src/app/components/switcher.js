...
export default function Switcher(){
    ...
    return(
        ...
        <Link href="#" onClick={scrollToTop}  id="back-to-top" className={`${scrollTop ? 'back-to-top fixed flex items-center  justify-center text-lg rounded-full z-10 bottom-5 end-5 h-9 w-9 text-center  bg-green-400 hover:bg-green-500 text-white  leading-9':'none'} `}><AiOutlineArrowUp/></Link>
        </>
    )
}
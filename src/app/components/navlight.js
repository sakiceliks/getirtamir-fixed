            ...
            <div className="container">
                <Link className="logo" href="/">
                    <span className="inline-block dark:hidden">
                        <Image src="/images/getirtamir-logo.png" width={128} height={24} className="h-6 l-dark" alt=""/>
                        <Image src="/images/getirtamir-logo.png" width={128} height={24} className="h-6 l-light" alt=""/>
                    </span>
                ...
                <ul className="buy-button list-none mb-0">
                    <li className="inline mb-0">
                        <Link href="/login">
                            ...
                            <span className="py-[6px] px-4 inline md:hidden items-center justify-center tracking-wider align-middle duration-500 text-sm text-center rounded bg-green-400 hover:bg-green-500 border border-green-400 hover:border-green-500 text-white font-semibold">Login</span>
                        </Link>
                    </li>
                ...
                <div id="navigation" className={`${toggleMenu ? 'block' : ''}`}>
                    <ul className="navigation-menu nav-light">
                        <li className="has-submenu parent-menu-item">
                            <Link href="#">Anasayfa</Link><span className="menu-arrow"></span>

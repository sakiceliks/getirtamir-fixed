                    ...
                    {featureData.map((item,index)=>{
                        ...
                        return(
                            <div className="group flex duration-500 xl:p-3" key={index}>
                                <div className="flex align-middle justify-center items-center w-14 h-14 mt-1 bg-green-400/5 group-hover:bg-green-400 group-hover:text-white border-2 border-green-400/20 text-green-400 rounded-lg text-2xl shadow-sm dark:shadow-gray-800 duration-500">

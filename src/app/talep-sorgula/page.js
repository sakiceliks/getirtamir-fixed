...
function TalepSorgula() {
  const [talepId, setTalepId] = useState('');

  return (
    <>  <div className="relative mx-auto flex h-10 w-full translate-y-20 mt-10 min-w-[200px] max-w-[24rem]">
      <Link href={`/talepler/${talepId}`} passHref>
      <button

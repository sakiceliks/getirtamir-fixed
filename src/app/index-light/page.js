                    ...
                    <div className="">
                        <h4 className="font-bold lg:leading-normal leading-normal text-4xl lg:text-6xl mb-5">The AI Content <br/> Plaform for 
                            <TypeAnimation
                                ...
                                wrapper="span"
                                speed={10}
                                className="typewrite bg-gradient-to-br from-green-400 to-fuchsia-600 text-transparent bg-clip-text ms-4"
                                repeat={Infinity}
                                />
                        </h4>
                        ...
                        <div className="mt-6">
                            <Link href="" className="py-2 px-5 inline-block font-semibold tracking-wide border align-middle duration-500 text-base text-center bg-green-400 hover:bg-green-500 border-green-400 hover:border-green-500 text-white rounded-md">Try For Free</Link>
        ...
        <section className="relative md:py-24 py-16">
            ...
            <div className="container relative md:mt-24 mt-16">
                <div className="grid grid-cols-1 pb-6 text-center">
                    <h3 className="mb-4 md:text-3xl md:leading-normal text-2xl leading-normal font-semibold">The right plans, <br/> <span className="bg-gradient-to-br from-green-400 to-fuchsia-600 text-transparent bg-clip-text">for the right price</span></h3>

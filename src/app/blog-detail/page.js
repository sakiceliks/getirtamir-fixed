...
export default function BlogDetails(){
    ...
    return(
        <>
        <Navbar/>
        <section className="relative md:pt-44 pt-36 bg-gradient-to-b from-green-400/20 dark:from-green-400/40 to-transparent">
            <div className="container relative">
                <div className="md:flex justify-center">
                    <div className="lg:w-2/3 md:w-4/5">
                        <Link href="" className="bg-green-400 text-white text-[12px] font-semibold px-2.5 py-0.5 rounded h-5">AI</Link>
                        ...
                        <div className="flex items-center mt-5">
                            ...
                            <div className="ms-2">
                                <h6><Link href="" className="font-medium hover:text-green-400">Calvin Carlo</Link><Link href="" className="ms-1 text-green-600 font-medium"><i className="mdi mdi-circle-medium"></i>Follow</Link></h6>
            ...
            <div className="container relative">
                <div className="md:flex justify-center">
                    <div className="lg:w-2/3 md:w-4/5">
                        ...
                        <div className="relative rounded-md border-s-4 border-green-400 px-6 py-10 mt-4">
                            ...
                            <div className="absolute text-8xl -top-0 start-4 text-green-500/10 dark:text-green-500/20 -z-1">
                        ...
                        <div className="flex justify-between py-4 border-y border-gray-100 dark:border-gray-700 mt-5">
                            <ul className="list-none">
                                <li className="inline"><Link href="#" className="inline-flex items-center text-slate-400"><FiHeart className="h-4 w-4 text-slate-900 dark:text-white hover:text-green-400 me-1"/> 233</Link></li>
                                <li className="inline ms-2"><Link href="#" className="inline-flex items-center text-slate-400"><FiMessageCircle className="h-4 w-4 text-slate-900 dark:text-white hover:text-green-400 me-1"/> 08 </Link></li>
                            </ul>

                            <ul className="list-none">
                                <li className="inline"><Link href="#" className="inline-flex items-center text-slate-400"><i data-feather="share-2" className="h-4 w-4 text-slate-900 dark:text-white hover:text-green-400"></i></Link></li>
                            </ul>
                        </div>
                                ...
                                <div className="flex items-center justify-between">
                                    <div className="flex items-center">
                                        ...
                                        <div className="ms-3 flex-1">
                                            <Link href="" className="font-semibold hover:text-green-400 duration-500">Calvin Carlo</Link>
                                            <p className="text-sm text-slate-400">August 26, 2023 at 01:25 pm</p>
                                        </div>
                                    </div>

                                    <Link href="" className="text-slate-400 hover:text-green-400 duration-500 ms-5"><i className="mdi mdi-reply"></i> Reply</Link>
                                </div>
                                    ...
                                    <div className="lg:col-span-6 mb-5">
                                        <div className="text-start">
                                            ...
                                            <div className="form-icon relative mt-2">
                                                ...
                                                <input name="name" id="name" type="text" className="form-input ps-11 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-green-400 dark:border-gray-800 dark:focus:border-green-400 focus:ring-0" placeholder="Name :"/>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="lg:col-span-6 mb-5">
                                        <div className="text-start">
                                            ...
                                            <div className="form-icon relative mt-2">
                                                ...
                                                <input name="email" id="email" type="email" className="form-input ps-11 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-green-400 dark:border-gray-800 dark:focus:border-green-400 focus:ring-0" placeholder="Email :"/>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div className="mb-5">
                                        <div className="text-start">
                                            ...
                                            <div className="form-icon relative mt-2">
                                                ...
                                                <textarea name="comments" id="comments" className="form-input ps-11 w-full py-2 px-3 h-28 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-green-400 dark:border-gray-800 dark:focus:border-green-400 focus:ring-0" placeholder="Message :"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <button type="submit" id="submit" name="send" className="py-2 px-5 inline-block tracking-wide border align-middle duration-500 text-base text-center bg-green-400 hover:bg-greenborder-green-500 border-green-400 hover:border-green-500 text-white rounded-md w-full">Send Message</button>
                            </form>
                        </div>
                    </div>
                </div>

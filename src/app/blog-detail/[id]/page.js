                ...
                <div className="md:flex justify-center">
                    <div className="lg:w-2/3 md:w-4/5">
                        ...
                        <div className="flex items-center mt-5">
                            ...
                            <div className="ms-2">
                                <h6><Link href="" className="font-medium hover:text-green-400">{data?.author}</Link><Link href="" className="ms-1 text-green-600 font-medium"><i className="mdi mdi-circle-medium"></i>Follow</Link></h6>

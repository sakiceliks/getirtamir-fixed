...
export default function Error(){
    return(
        <>
         <section className="relative overflow-hidden h-screen flex items-center bg-green-400/5 dark:bg-green-400/10">
                    ...
                    <div className="lg:w-1/2">
                        ...
                        <div className="mt-8">
                            ...
                            <div className="text-center">
                                ...
                                <div className="mt-6">
                                    <Link href="/" className="py-2 px-5 inline-block font-semibold tracking-wide border align-middle duration-500 text-base text-center bg-green-400 hover:bg-green-500 border-green-400 hover:border-green-500 text-white rounded-md">Back to Anasayfa</Link>
                                </div>
                            </div>
                        </div>
                    </div>
